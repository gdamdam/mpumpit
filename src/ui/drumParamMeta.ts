...
export const DRUM_PARAMS: DrumKnob[] = [
  { key: "tune", label: "TUNE", min: -24, max: 24, step: 1 },
  { key: "decay", label: "DECAY", min: 0.2, max: 3.0, step: 0.05 },
  { key: "level", label: "LEVEL", min: 0, max: 1, step: 0.01 },
  { key: "pan", label: "PAN", min: -1, max: 1, step: 0.05 },
  { key: "click", label: "CLICK", min: 0, max: 1, step: 0.01 },
  { key: "clickTune", label: "CLK TUNE", min: -1, max: 1, step: 0.05 },
  { key: "sweepDepth", label: "SWEEP", min: 0, max: 1, step: 0.01 },
  { key: "sweepRate", label: "SWP RATE", min: 0, max: 1, step: 0.01 },
  { key: "noiseMix", label: "NOISE", min: 0, max: 1, step: 0.01 },
  { key: "color", label: "COLOR", min: -1, max: 1, step: 0.05 },
  { key: "filterCutoff", label: "LPF", min: 0, max: 1, step: 0.01 },
];
