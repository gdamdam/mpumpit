...
/** The four logical instrument parts mpumpit exposes. */
export type Part = "synth" | "chords" | "bass" | "drums";

export const PARTS: readonly Part[] = ["synth", "chords", "bass", "drums"] as const;
 ...
 * chords=2 is free between bass=1 and drums=9.
 */
