...
// ── Drum kit presets (24: 16 kits + 8 classic machines) ───────────────────
...
export const DRUM_KIT_PRESETS: DrumKitPreset[] = [
  ...
  // ── Classic machines (imported from mpump's SAMPLE_PACKS) ──────────────────
  // Synthesized kits modeled after vintage drum machines. mpumpit has no separate
  // "Machines" group, so these live alongside the kits above in one flat list.
  { name: "CR-78", genres: "Early Electro, Italo, New Wave", voices: kit({
  ...
  { name: "DMX", genres: "Electro, Hip-Hop, Breakdance", voices: kit({
  ...
  { name: "Drumulator", genres: "Electro, Synth-Pop, EBM, Synthwave", voices: kit({
  ...
  { name: "LinnDrum", genres: "Synth-Pop, New Wave, Hip-Hop", voices: kit({
  ...
  { name: "TR-606", genres: "Acid, Minimal, Electro", voices: kit({
  ...
  { name: "TR-707", genres: "Italo, Early House, Synth-Pop", voices: kit({
  ...
  { name: "TR-808", genres: "Hip-Hop, Trap, Electro", voices: kit({
  ...
  { name: "TR-909", genres: "Techno, House, Trance", voices: kit({
